...
Let us illustrate how one might setup a sequential learning run based on [a real-world
...
to force a transition between the closed and open pore phases. This transition is 
  </figcaption>
</figure>
